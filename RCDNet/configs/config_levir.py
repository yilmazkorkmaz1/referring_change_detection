...
C.root_folder = osp.abspath(osp.join(C.root_dir, 'data', 'LEVIR-CD256'))
C.A_format = '.png'
C.B_format = '.png'
C.gt_format = '.png'
C.is_test = False
...
C.num_classes = 2
C.class_names =  ['background', 'building']
C.normalize_binary_gt = True  # Convert 255 -> 1 for binary CD datasets (LEVIR, WHU, etc.)
...
# A: [0.451, 0.448, 0.383], B: [0.342, 0.335, 0.285]
C.norm_mean = np.array([0.397, 0.391, 0.334])
C.norm_std = np.array([0.186, 0.177, 0.164])

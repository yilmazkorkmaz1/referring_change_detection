...
"""Dataset Path"""
C.dataset_name = 'WHU'
C.root_folder = osp.abspath(osp.join(C.root_dir, 'data', 'WHU-CD-256'))
C.A_format = '.png'
C.B_format = '.png'
C.gt_format = '.png'
C.is_test = False
...
C.normalize_binary_gt = True  # Convert 255 -> 1 for binary CD datasets
...
# A: [0.486, 0.446, 0.389], B: [0.485, 0.483, 0.462]
C.norm_mean = np.array([0.486, 0.465, 0.426])
C.norm_std = np.array([0.194, 0.187, 0.196])
